...
from Model.PDE_Model_Reg import PBE
...
class PDE():
        ...
        def create_simulation(self):
                ...
                self.meshes_in = dict()
                self.meshes_in['1'] = {'type':'R', 'value':0.0}
                self.meshes_in['2'] = {'type':'Q', 'value':0.0}
                self.meshes_in['3'] = {'type':'K', 'file':'data_known_reg.dat', 'noise': True}
                ...
                self.meshes_out['3'] = {'type':'K', 'file':'data_known_reg.dat', 'noise': True}
