...
density = 3
mesh = trimesh.creation.icosphere(radius=1.0, subdivisions=density)
...
with open(os.path.join(file_path,f'born_ion_d{density}.vert'), 'w') as vertex_file:
...
with open(os.path.join(file_path,f'born_ion_d{density}.face'), 'w') as faces_file:
    for face in faces:
